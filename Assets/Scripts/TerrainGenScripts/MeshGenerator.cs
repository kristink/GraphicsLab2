...
public class MeshGenerator : MonoBehaviour {
    ...
    [SerializeField]
    GenerateTerrainObjects generateTerrainObjects;
        ...
        for (int i = chunks.Count - 1; i >= 0; i--) {
            ...
            if (sqrDst > sqrViewDistance) {
                ...
                if (chunk.coord.y == 0)
                {
                    ...
                    //TODO remove island stuff too
                }
                generateTerrainObjects.RemoveObejcts(chunk);
                    ...
                    if (sqrDst <= sqrViewDistance) {
                        ...
                        if (IsVisibleFrom (bounds, Camera.main)) {
                            if (recycleableChunks.Count > 0) {
                                ...
                                generateTerrainObjects.GenerateObjects(chunk, boundsSize);
    ...
    Chunk CreateChunk (Vector3Int coord) {
        ...
        //newChunk.islandObjectPointList = PoissonDiscSampling.GeneratePoints(radius, regionSize, rejectionSamples);
        return newChunk;
    }
